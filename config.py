...
# GPU visual renderer settings
ENABLE_VISUAL_RENDERER = True
VISUAL_RENDERER_WIDTH = 1280
VISUAL_RENDERER_HEIGHT = 720
VISUAL_RENDERER_FPS = 60
VISUAL_RENDERER_VSYNC = True
